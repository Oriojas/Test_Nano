...
dataset = "/content/drive/My Drive/Colab Notebooks/GAN_INS/Data_Ins" # carpeta donde guardo las imagenes verdaderas de entrenamiento
ejemplos = "/content/drive/My Drive/Colab Notebooks/GAN_INS/Ejemplo_Ins"
...
def graficar_imagenes_generadas(epoch, generador, ejemplos=16, dim=(4,4), figsize=(10,10)):
    ...
    for i in range(ejemplos):
        ...
        plt.axis('off')
    plt.tight_layout()
    plt.savefig("/content/drive/My Drive/Colab Notebooks/GAN_INS/Ejemplo_Ins/GAN_imagen_generada_%d.png" %epoch)
    plt.close()
...
TAM_LOTE = 45 # tamaño del lote de las imagenes que se le pasaran al los modelos
N_ITS = 8000 # cantidad de iteraciones del modelo
...
for i in range(1,N_ITS+1):
    ...
    if i==1 or i%500 == 0: # cada 500 iteraciones grafico las imagenes
        ...
        generador.save("/content/drive/My Drive/Colab Notebooks/GAN_INS/Ejemplo_Ins/generador.h5")
        
generar_imagenes(generador,100)

# serializar el modelo a JSON
generador_json = generador.to_json()
with open("/content/drive/My Drive/Colab Notebooks/GAN_INS/Ejemplo_Ins/generador.json", "w") as json_file:
