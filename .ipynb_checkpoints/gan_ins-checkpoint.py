...
TAM_LOTE = 10 # tamaño del lote de las imagenes que se le pasaran al los modelos
N_ITS = 100 # cantidad de iteraciones del modelo
...
for i in range(1,N_ITS+1):
    ...
    if i==1 or i%500 == 0: # cada 500 iteraciones grafico las imagenes
        ...
        generador.save("/Test_Nano/generador.h5")
        
generar_imagenes(generador,100)

# serializar el modelo a JSON
generador_json = generador.to_json()
with open("/Test_Nano/generador.json", "w") as json_file:
